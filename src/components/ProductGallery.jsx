  ...
  return (
    <section ref={container} className="py-24 px-6 md:px-12 lg:px-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
        ...
        <div className="gallery-text-content w-full lg:w-[45%] space-y-8 order-2 lg:order-1">
        ...
        <div className="w-full lg:w-[55%] grid grid-cols-2 gap-4 md:gap-6 items-center h-auto md:h-[65vh] order-1 lg:order-2">
          ...
          <div className="space-y-4 md:space-y-6 h-full flex flex-col">
            <div className="gallery-card group relative overflow-hidden rounded-[3rem] md:rounded-[4rem] shadow-xl transition-all duration-700 flex-1 gpu-accelerated">
          ...
          {/* Column 2: Tall */}
          <div className="gallery-card group relative overflow-hidden rounded-[3rem] md:rounded-[4rem] shadow-xl h-full transition-all duration-700 gpu-accelerated">
